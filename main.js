...
// Dastlabki holatni darhol ko‘rsatish
updateTimer();
...
// Modal ochish
openBtnHero.onclick = () => formModal.style.display = 'flex';
openBtnTaqdimot.onclick = () => formModal.style.display = 'flex';
...
// Obuna tugmasi
subscribeBtn.onclick = () => window.open(TG_LINK, '_blank');
